Shader "KYU3D/Scene/Terrain"
{
	Properties
	{
		[HideInInspector]_MainTex( "_MainTex", 2D ) = "green" {}
		[HideInInspector]_Color( "_Color", Color ) = ( 0, 1, 0, 1 )
		[HideInInspector]_Control( "_Control", 2D ) = "red" {}
		[HideInInspector]_Splat0( "_Splat0", 2D ) = "gray" {}
		[HideInInspector]_Splat1( "_Splat1", 2D ) = "gray" {}
		[HideInInspector]_Splat2( "_Splat2", 2D ) = "gray" {}
		[HideInInspector]_Splat3( "_Splat3", 2D ) = "gray" {}
	}
