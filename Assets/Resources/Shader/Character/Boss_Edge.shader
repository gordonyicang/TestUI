...
Shader "KYU3D/Character/Boss_Edge"
{
	Properties
	{
		...
		_EdgeColor( "_EdgeColor", Color ) = ( 0.9, 0.55, 0.15, 1 )
		_EdgePow( "_EdgePow", float ) = 1.3
		_EdgeIntensity( "_EdgeIntensity", float ) = 2
	}
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag( v2f i ) : COLOR
			{
				...
				half r0 = 1 - dot( i.normal, i.view );
				half e = pow( r0, _EdgePow );
				half r = r0 * r0;
				r *= r;
